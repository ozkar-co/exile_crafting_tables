local variants = {
    {
        suffix = "granite",
        description = "Granite Grinding Wheel",
    },
    {
        suffix = "basalt",
        description = "Basalt Grinding Wheel",
    },
    {
        suffix = "limestone",
        description = "Limestone Grinding Wheel",
    },
}

for _, variant in ipairs(variants) do
    minetest.register_node("exile_crafting_tables:grinding_wheel_" .. variant.suffix, {
        description = variant.description,
        drawtype = "nodebox",
        tiles = {
            "exile_crafting_tables_grinding_wheel_top_" .. variant.suffix .. ".png",
            "exile_crafting_tables_grinding_wheel_bottom.png",
            "exile_crafting_tables_grinding_wheel_side_" .. variant.suffix .. ".png",
            "exile_crafting_tables_grinding_wheel_side_" .. variant.suffix .. ".png",
            "exile_crafting_tables_grinding_wheel_face_" .. variant.suffix .. ".png",
            "exile_crafting_tables_grinding_wheel_face_" .. variant.suffix .. ".png",
        },
        stack_max = 1,
        paramtype = "light",
